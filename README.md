...
As the accuracy of the model increases, the loss decreases. The final model has an accuracy of 80% and a loss of 0.3. The model is able to predict the class of the lesion with a high accuracy.
